    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mentors.map((mentor) => {
            const fullName = mentor.profiles?.full_name || "Mentor";
            ...
            return (
              <div key={mentor.user_id} className="glass p-6 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-4">
                  {avatarUrl ? (
                    <img src={avatarUrl} alt={fullName} className="w-14 h-14 rounded-full object-cover border-2 border-[var(--c-primary)]" />
                  ) : (
                  ...
                  <div>
                    <h3 className="font-bold text-[var(--c-text)] font-['Plus_Jakarta_Sans'] text-lg line-clamp-1">{fullName}</h3>
